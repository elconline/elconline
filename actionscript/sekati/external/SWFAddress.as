...
package sekati.external {
	...
	import sekati.events.SWFAddressEvent;	
	...
	public class SWFAddress {
		...
		protected static var _strict : Boolean = true;
		protected static var _value : String = '';
		protected static var _interval : Number;
		protected static var _availability : Boolean = ExternalInterface.available;
		...
		protected static function _initialize() : Boolean {
			if (_availability) {
		...
		protected static var _initializer : Boolean = _initialize( );
		...
		protected static function _strictCheck(value : String, force : Boolean) : String {
			if (_strict) {
				if (force) {
		...
		protected static function _getValue() : String {
		...
		protected static function _setValue(value : String) : void {        
			if (value == 'undefined' || value == null) value = '';
		...
		protected static function _dispatchEvent(type : String) : void {
		...
		/**
		 * SWFAddress Static Constructor
		 */
		public function SWFAddress() {
			throw new Error( "SWFAddress is a static class and cannot be instantiated." );
		}
	}
}